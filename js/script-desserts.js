/*For fetching dessert recipees*/

const url = "https://headlesscms.linnwilhelmsen.net/wp-json/wp/v2/posts?categories=22";
const recipeContainer = document.querySelector(".recipees-desserts");
